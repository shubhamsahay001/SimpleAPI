...
{   
       ...
       public void GetReturnBangaloreData()
    {
        ...
        Assert.Equal("The average temparature in Bangalore will be 25.5 degree celsius in this week", returnValue);
    }
       ...
       public void GetReturnBengaluruData()
    {
        ...
        Assert.Equal("The average temparature in Bengaluru will be 25.5 degree celsius in this week", returnValue);
    }
